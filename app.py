...
def classify_city(city):
    ...
    city_map = {
        ...
        "منطقة الجهراء": {"الجهراء","الصلبية الصناعية","الصليبية الصناعية","مزارع الصليبية",
                          "الصليبية السكنية","مدينة سعد العبدالله","الصليبية","أمغرة","سكراب امغرة",
...
# ---------- PDF table builder ----------
def df_to_pdf_table(df, title="SOUQ"):
...
# ---------- Streamlit App ----------
st.set_page_config(page_title="💛 SOUQ Orders Processor", layout="wide")
st.title("💛 SOUQ Orders Processor")
st.markdown("صباح الفل يا هندسة- ارفع الملفات علشان تستلم الشيت")
